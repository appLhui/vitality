 ...
 * To change this template use File | Settings | File Templates.
 */
define("plug-in/chosen", function(require, exports, module) {
        ...
        AbstractChosen = function() {
            ...
            AbstractChosen.prototype.set_default_text = function() {
                if (this.form_field.getAttribute("data-placeholder")) {
                    ...
                    this.default_text = this.options.placeholder_text_multiple || this.options.placeholder_text || "请选择多项";
                } else {
                    this.default_text = this.options.placeholder_text_single || this.options.placeholder_text || "请选择一项";
                }
                return this.results_none_found = this.form_field.getAttribute("data-no_results_text") || this.options.no_results_text || "没有匹配的结果";
            };
        ...
        $.fn.extend({
            chosen: function(option) {
                ...
                return this.each(function(input_field) {
                    ...
                    if (!data && !$this.hasClass("chzn-done")) {
                        return $this.data("chosen", new Chosen(this, options));
                    }
                    if (typeof option === "string") $this.trigger("liszt:" + option);
                });
            }
        });
        Chosen = function(_super) {
            ...
            Chosen.prototype.results_show = function() {
                ...
                if (!this.is_multiple) {
                    ...
                    this.form_field_jq.trigger("maxselected", {
                        chosen: this
                    });
                    return false;
                }
