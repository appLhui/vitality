 ...
 * To change this template use File | Settings | File Templates.
 */
define("plug-in/datetimepicker", function(require, exports, module) {
    ...
    (function($) {
        ...
        DateTimePicker.prototype = {
            ...
            doAction: function(e) {
                e.stopPropagation();
                e.preventDefault();
                if (!this._date) this._date = UTCDate(2011, 0, 0, 0, 0, 0, 0);
            ...
            _attachDatePickerEvents: function() {
                ...
                if (this.pickDate && this.pickTime) {
                    ...
                    this.widget.on("mouseover.togglePicker", ".accordion-toggle", function(e) {
                        e.stopPropagation();
                        $(this).find("i").addClass("icon-white");
                    });
                    this.widget.on("mouseout.togglePicker", ".accordion-toggle", function(e) {
                        e.stopPropagation();
