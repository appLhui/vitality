 ...
 */
define("plug-in/daterangepicker", function(require, exports, module) {
    Date.CultureInfo = {
        name: "en-US",
    ...
    !function($) {
        var DateRangePicker = function(element, options) {
            options = $.extend({}, $.fn.daterangepicker.defaults, options);
            ...
            var DRPTemplate = '<div class="daterangepicker dropdown-menu">' + '<div class="calendar left"></div>' + '<div class="calendar right"></div>' + '<div class="ranges">' + '<div class="range_inputs">' + '<div style="float: left">' + '<label for="daterangepicker_start">' + this.locale.fromLabel + "</label>" + '<input class="input-mini" type="text" name="daterangepicker_start" value="" disabled="disabled" />' + "</div>" + '<div style="float: left; padding-left: 11px">' + '<label for="daterangepicker_end">' + this.locale.toLabel + "</label>" + '<input class="input-mini" type="text" name="daterangepicker_end" value="" disabled="disabled" />' + "</div>" + '<button class="btn btn-small btn-success" disabled="disabled">' + this.locale.applyLabel + "</button>" + "</div>" + "</div>" + "</div>";
        ...
        $.fn.daterangepicker = function(options) {
            this.each(function() {
                ...
                if (!el.data("daterangepicker")) {
                    if ($input) {
                        el.data("daterangepicker", new DateRangePicker($input, options));
                    } else {
