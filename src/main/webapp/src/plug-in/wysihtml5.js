    ...
    !function($, wysi) {
        ...
        var tpl = {
            ...
            "lists": function(locale, options) {
                return "<li>" +
                    "<div class='btn-group'>" +
                    "<a class='btn btn-small' rel='tooltip' title='项目符号列表' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "'><i class='icon-list'></i>" + locale.lists.unordered + "</a>" +
                    "<a class='btn btn-small' rel='tooltip' title='编号列表' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "'><i class='icon-th-list'></i>" + locale.lists.ordered + "</a>" +
                    "<a class='btn btn-small' rel='tooltip' title='添加引用' data-wysihtml5-command='Outdent' title='" + locale.lists.outdent + "'><i class='icon-indent-right'></i>" + locale.lists.outdent + "</a>" +
                    "<a class='btn btn-small' rel='tooltip' title='取消引用' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "'><i class='icon-indent-left'></i>" + locale.lists.indent + "</a>" +
                    "</div>" +
                    "</li>";
            },
            ...
            "link": function(locale, options) {
                ...
                return "<li>" +
                    ...
                    "</div>" +
                    "</div>" +
                    "<a class='btn btn-small' data-wysihtml5-command='createLink'rel='tooltip' title='插入链接' title='" + locale.link.insert + "'><i class='icon-globe'></i>" + locale.link.insert + "</a>" +
                    "</li>";
            },
            ...
            "html": function(locale, options) {
                return "<li>" +
                    "<div class='btn-group'>" +
                    "<a class='btn btn-small' data-wysihtml5-action='change_view' title='" + locale.html.edit + "'><i class='icon-pencil'></i>" + locale.html.edit + "</a>" +
                    "</div>" +
                    "</li>";
            },
                    ...
                    if (options.upload) {
                        options.uploadOptions.onUploadSuccess=function(file, data, response){
                            if (response) {
                                ...
                                wys.editor.composer.commands.exec("insertImage",{ src:rData.filePath, title: rData.fileName,style:"max-width:500px"});
                                onUploadSuccess();
                            }
                        };
        ...
        var defaultOptions = $.fn.wysihtml5.defaultOptions = {
            ...
            "upload":true,
            "id":$(this).attr('id'),
            uploadOptions:{'swf': 'develop/js/base/uploadify.swf'},
            events: {},
            parserRules: {
                classes: {
